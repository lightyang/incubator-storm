...
public class TracedDisruptorQueue extends DisruptorQueue {
    ...
    public TracedDisruptorQueue(String queueName, ClaimStrategy claim, WaitStrategy wait, Map<String, Object> conf) {
        super(queueName, claim, wait);
        ...
        this.sampleInterval = (int) (1 / sampleRate);
    }
